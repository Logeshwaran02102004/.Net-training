...
using static ADODisconnecteddemo.empoyees;
...
namespace ADODisconnecteddemo
{
    ...
    internal class linqdemo
    {
        List<empdet> employees = new List<empdet>
     {
        ...
        public void Demo1()
        {
            string[] studentnames = { "Logesh", "waseef", "keerthik", "prathees", "sakthi" };

            //show all the names starts with the a
            var res = from t in studentnames
                      where t.StartsWith("L")
                      select t;
